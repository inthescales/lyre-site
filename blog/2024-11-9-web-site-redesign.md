...
As well as displaying the word of the day on the web site, I've also added [an RSS feed](/wotd-feed.xml) that publishes each day's word. With this, it is now possible to read from Lyre's Dictionary outside of any social media site.
